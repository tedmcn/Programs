...
public class PersonalityTest {
	...
	public static void compileAnswers(String inputFile) throws FileNotFoundException {
		...
		// Count variable created for answers array traversing.
		int count = 0;
		...
		while (file.hasNextLine()) {
			...
			// Assigns line containing test takers answers to String for answers array.
			String answers = file.nextLine();
			// Populates array with each possible character answer (A, B or -) for each test taker.
			for(int i = 0; i < 70; i++) {
	...
	public static String askFileName() {
		...
		// Returns the confrimed existing String name of the input file which will be read.
		return inputFile;
	}
}